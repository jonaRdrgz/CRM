    ...
    {   
        ...
        private void imprimirOpcionesAdmin()
        {
            Response.Write(
                ...
                + "<li class='treeview'>"
                + "<a href = '#' >"
                + "<i class='fa fa-check-square'></i> <span>Propuestas</span>"
                + "<span class='pull-right-container'>"
                + "<i class='fa fa-angle-left pull-right'></i>"
                + "</span>"
                + "</a>"
                + "<ul class='treeview-menu'>"
                + "<li><a href = 'Contactos.aspx' ><i class='fa fa-circle-o'></i> Mis Propuestas</a></li>"
                + "<li><a href = 'Contactos.aspx' ><i class='fa fa-circle-o'></i> Crear Propuesta</a></li>"
                + "<li><a href = 'InfoEmpresas.aspx'><i class='fa fa-circle-o'></i> Eliminar Propuestas</a></li>"
                + "</ul>"
                + "</li>"
                );
        }
