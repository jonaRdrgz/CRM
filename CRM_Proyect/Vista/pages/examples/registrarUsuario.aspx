<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registrarUsuario.aspx.cs" Inherits="CRM_Proyect.pages.examples.registrar" %>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  ...
  <div class="register-box-body">
    <p class="login-box-msg">Registrar una nueva persona</p>
      ...
      <div class="form-group has-feedback">
        ...
        <asp:RequiredFieldValidator CssClass="help-block"  Display = "Dynamic" runat="server" id="RequiredFieldValidator2" controltovalidate="TextBoxNombre" errormessage="¡Por favor ingrese su nombre!" ForeColor="Red"/>
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <asp:TextBox CssClass="form-control" ID="TextBoxApellido1" placeholder="Primer Apellido"  runat="server"></asp:TextBox>
        <asp:RequiredFieldValidator CssClass="help-block" Display = "Dynamic" runat="server" id="RequiredFieldValidator1" controltovalidate="TextBoxApellido1" errormessage="¡Por favor ingrese su primer apellido!" ForeColor="Red" />
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <asp:TextBox CssClass="form-control" ID="TextBoxApellido2" placeholder="Segundo Apellido"  runat="server"></asp:TextBox>
        <asp:RequiredFieldValidator CssClass="help-block"  Display = "Dynamic" runat="server" id="RequiredFieldValidator3" controltovalidate="TextBoxApellido2" errormessage="¡Por favor ingrese su segundo apellido!" ForeColor="Red" />
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
       ...
       <div class="form-group has-feedback" >
        ...
        <asp:RequiredFieldValidator CssClass="help-block" Display = "Dynamic" runat="server" id="RequiredFieldValidator4" controltovalidate="TextBoxDireccion" errormessage="¡Por favor ingrese su dirección!" ForeColor="Red" />
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
       <div class="form-group has-feedback">
        <asp:TextBox CssClass="form-control" ID="TextBoxTelefono" placeholder="Teléfono"  runat="server"></asp:TextBox>
        <asp:RequiredFieldValidator CssClass="help-block" Display = "Dynamic" runat="server" id="RequiredFieldValidator6" controltovalidate="TextBoxTelefono" errormessage="¡Por favor ingrese su telefono!" ForeColor="Red" />
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
