<%@ Page Title="" Language="C#" MasterPageFile="~/Vista/Home.Master" AutoEventWireup="true" CodeBehind="ComentarPropuesta.aspx.cs" Inherits="CRM_Proyect.ComentarPropuesta" %>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Ingresar Comentario</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form">
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="3" id="comentario" placeholder="Enter ..."></textarea>
                </div>
                  <div class="box-footer">
                    <button type="button" id="botonComentar" onclick='agregarComentario()' class="btn btn-primary" disabled>Agregar Comentario</button>
                 </div>
...
<script>
  $(function () {
      ...
      mostrarPropuestasVentaComprasUsuario();
  })
</script>
</asp:Content>
